 ...
 * <p/>
 * URL is always required as the first argument, optionally followed by timeout, http status and on error message
 ...
 *
 *    {@literal @}Test
 *    {@literal @}RunIf(value = URLIsReachable.class, arguments = {"http://www.google.com", "5000", "200", "google is
 * offline"})
    ...
    implements Checker
{
   ...
   * @throws IllegalArgumentException if first arg is a malformed {@link URL}, the number of arguments is less than
   *                                  one or greater than 4, or arguments 2 and three cannot be parsed as integer
   */
  ...
  public boolean satisfy() {
    try {
      ...
      LoggerFactory.getLogger(this.getClass()).warn("{} caused test to be ignored {}: {}", new Object[]{
          this.getClass().getSimpleName(), this.message != null ? "(" + this.message + ")" : "", ae.getMessage()
      });
      return false;
    }
    return true;
